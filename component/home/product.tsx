        ...
        <div className="flex items-center gap-2.5 overflow-x-auto pb-4 sm:mb-14 mb-8 no-scrollbar max-w-full px-2">
          {CATEGORIES.map((cat) => (
            <button
              ...
              className={`px-5 py-2 rounded-full border text-xs md:text-sm font-semibold tracking-wide transition-all duration-300 whitespace-nowrap cursor-pointer ${activeCategory === cat
